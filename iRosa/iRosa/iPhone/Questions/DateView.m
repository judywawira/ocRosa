...
- (id)initWithFrame:(CGRect)frame {
    ...
    NSArray* nibViews =  [[NSBundle mainBundle] loadNibNamed:@"DateView" owner:self options:nil];
...
- (void)adjustSubviews {
    ...
    // Select the date already encoded in the result... or today 
    picker.date = [self.controller.control decodeResultToDate];
}
