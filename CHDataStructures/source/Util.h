 ...
 */
OBJC_EXPORT BOOL objectsAreEqual(id o1, id o2);
 ...
 */
OBJC_EXPORT BOOL objectsAreIdentical(id o1, id o2);
 ...
 */
OBJC_EXPORT NSUInteger hashOfCountAndObjects(NSUInteger count, id o1, id o2);
